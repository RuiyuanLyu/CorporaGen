OBJECT_TEMPLATES_QUESTION_AND_ANSWER = [
    # Basic Description
    ["What is the {color} {fine_grained_category} made of?",['{material}']],
    ["What is the size of the {fine_grained_category} with a {color} {texture} texture?",["{size}"]],
